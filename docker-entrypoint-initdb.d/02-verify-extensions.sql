...
--
-- Runs after 00 (age) and 01 (vector, pg_textsearch, pg_trgm, libversion)
...
-- caught failure (see docs/roadmap and ADR-0005/ADR-0007). No-op once all five exist.
DO $$
DECLARE
  expected text[] := ARRAY['age', 'vector', 'pg_textsearch', 'pg_trgm', 'libversion'];
  missing  text[];
BEGIN
